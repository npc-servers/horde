...
HORDE.Difficulty = {
    [1] = {
        name = "INVASION", -- Easy difficulty, no Elites, more enemies.
    ...
    [4] = {
        name = "HELL", -- Medium-hard difficulty, Elites only.
        damageMultiplier = 2,
        enemyCountMultiplier = 1,
        rewardMultiplier = 0.4,
        healthMultiplier = 2,
    ...
    [6] = {
        name = "HORDE", -- Veteran difficulty, 100% mutation, extra enemies.
