...
HORDE.Difficulty = {
    ...
    [2] = {
        name = "APOCALYPSE", -- Normal difficulty.
    ...
    [3] = {
        name = "SWARM", -- Medium difficulty, more enemies.
        damageMultiplier = 1.8,
        enemyCountMultiplier = 1.4,
    ...
    [4] = {
        name = "CHAOS", -- Hard difficulty, 100% mutation for non-Elite.
        damageMultiplier = 2,
