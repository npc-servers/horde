...
HORDE.Difficulty = {
    ...
    [6] = {
        name = "ELITE-RUSH", -- Elites only, Hard/Veteran spawns, Normal difficulty.
        damageMultiplier = 1.6,
        enemyCountMultiplier = 1,
        rewardMultiplier = 0.4,
        healthMultiplier = 1.6,
    ...
    [7] = {
        name = "BOSS-RUSH", -- Bosses spawn every wave, Normal difficulty.
        damageMultiplier = 1.6,
        enemyCountMultiplier = 1,
        rewardMultiplier = 0.4,
        healthMultiplier = 1.6,
    ...
    [8] = {
        name = "APRIL-FOOLS", -- 2026 April Fools event, 1.5x extra enemies, Normal difficulty.
        damageMultiplier = 1.6,
        enemyCountMultiplier = 2.1,
        rewardMultiplier = 0.4,
        healthMultiplier = 1.6,
        startMoneyMultiplier = 1.1,
        spawnRadiusMultiplier = 0.5,
