...
function HORDE:SpawnManhack(ply, id)
    ...
    timer.Simple(0.1, function ()
        ...
        ent:AddRelationship("npc_vj_horde_spectre")
        ent:AddRelationship("npc_vj_horde_antlion")
        ent:AddRelationship("npc_vj_horde_smg_turret")
        ent:AddRelationship("npc_vj_horde_shotgun_turret")
        ent:AddRelationship("npc_vj_horde_rocket_turret")
        ent:AddRelationship("npc_vj_horde_laster_turret")
        ent:AddRelationship("npc_vj_horde_class_survivor")
        ent:AddRelationship("npc_vj_horde_class_assault")
        ent:AddRelationship("npc_vj_horde_vortigaunt")
        ent:AddRelationship("npc_vj_horde_combat_bot")
