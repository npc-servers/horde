...
net.Receive("Horde_RenderEnemiesCount", function()
    ...
    if is_boss then
        center_panel_str = "|" .. translate.Get("Game_Difficulty_" .. HORDE.difficulty_text[HORDE.CurrentDifficulty]) .. "|  " .. "BOSS"
    else
        center_panel_str = "|" .. translate.Get("Game_Difficulty_" .. HORDE.difficulty_text[HORDE.CurrentDifficulty]) .. "|  " .. translate.Get("Game_Enemies") .. ": " .. tostring(count)
    end
end)
...
net.Receive("Horde_RenderObjectives", function()
    ...
    center_panel_str = "|" .. translate.Get("Game_Difficulty_" .. HORDE.difficulty_text[HORDE.CurrentDifficulty]) .. "|  " .. "Objectives: " .. tonumber(count) .. "/" .. tonumber(max_count)
end)
...
net.Receive("Horde_SyncEscapeStart", function ()
    center_panel_str = "|" .. translate.Get("Game_Difficulty_" .. HORDE.difficulty_text[HORDE.CurrentDifficulty]) .. "|  " .. "Escape!"
end)
