...
На {1} увеличена устойчивость к любому урону. ({2} за каждый уровень, до {3}).
На {4} увеличена скорость передвижения, блокирует {5} урона.

Воздушное парирование: Прыгните, чтобы уменьшить физический урон на {6}.]]
...
На {1} увеличено максимальное здоровье. ({2} + {3} за каждый уровень, до {4}).

{5} шанс получить Гипертрофию когда вы ударяете врага ({6} шанс при попадании в голову).
100% шанс получить Гипертрофию когда вас ударили.
Гипертрофия понижает полученный физический урон на {7}.
Гипертрофия предоставляет {8} регенерации здоровья в секунду.
...
Бомбардирует территорию 5 крупными взрывами после 10 секундной задержки.
Завершается детонацией ядерной бомбы, наносящей огромный урон от взрыва.
