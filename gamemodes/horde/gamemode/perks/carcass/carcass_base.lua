...
PERK.Description = [[
The Carcass class sacrifices all firepower for unmatched strength and agility.
Complexity: HIGH
...
Cannot use any other weapons except for your medkit, but can upgrade fist damage.
LMB: Punch
