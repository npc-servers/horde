...
function HORDE:GetDefaultItemInfusions()
    ...
    HORDE.items["arccw_horde_bo_stakeout"].infusions = ballistic_infusions_light
...
function HORDE:GetDefaultItemsData()
    ...
    HORDE:CreateItem( "SMG", "Nailgun", "arccw_horde_nailgun", 1750, 4,
        ...
        { Prototype = true, Assault = true, SpecOps = true, Reverend = true, Engineer = true, Berserker = true, ["Cyborg Ninja"] = true },
    ...
    HORDE:CreateItem( "Shotgun", "Impaler", "arccw_horde_nailshot", 2750, 5,
        "Heavily modified Pneumatic Nailgun.\nFires nails in a shotgun style pattern.",
        { Prototype = true, Assault = true, SpecOps = true, Reverend = true, Engineer = true, ["Cyborg Ninja"] = true, Warden = true, Overlord = true },
