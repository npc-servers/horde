...
function HORDE:GetDefaultItemsData()
    ...
    HORDE:CreateItem("Special",    "Survivor",     "npc_vj_horde_class_survivor",   1750, 4, "A Survivor class human that acts as a multipurpose fighter. \nUses an AR15 rifle and grenades.",
    ...
    HORDE:CreateItem("Special",    "Assault",     "npc_vj_horde_class_assault",   2500, 5, "An Assault class human that uses automatic rifles. \nUses an M16 rifle with M203 UBGL and stun grenades.",
