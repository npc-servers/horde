...
function HORDE:GetDefaultItemsData()
    ...
    HORDE:CreateItem( "Shotgun", "Shotgun", "arccw_horde_shotgun", 100, 2,
        ...
        { Engineer = true, Warden = true, Overlord = true, Cremator = true },
        2, -1, nil, "items/hl2/weapon_shotgun.png", nil, nil, { HORDE.DMG_BALLISTIC }, nil, { "Engineer", "Warden", "Overlord" } )
    ...
    HORDE:CreateItem( "Shotgun", "Striker", "arccw_horde_striker", 2750, 7, "Armsel Striker.\nA 12-gauge shotgun with a revolving cylinder from South Africa.",
        { Assault = true, SpecOps = true, Reverend = true, Heavy = true, Juggernaut = true, Engineer = true, Warden = true, Overlord = true },
    ...
    HORDE:CreateItem( "Shotgun", "HSG-1", "arccw_horde_hsg1", 3000, 8,
        ...
        { Warden = true, Overlord = true }, 15, -1, nil, nil, { Warden = 2 }, nil, { HORDE.DMG_BALLISTIC } )
    HORDE:CreateItem( "Shotgun", "AA12", "arccw_horde_aa12", 3750, 9,
        "Atchisson Assault Shotgun.\nDevastating firepower at close to medium range.",
        { Heavy = true, Juggernaut = true, Warden = true, Overlord = true }, 25, -1, nil, nil, { Warden = 3 }, nil, { HORDE.DMG_BALLISTIC } )
