...
function HORDE:GetDefaultItemsData()
    HORDE:CreateItem( "Melee", "Combat Knife", "arccw_horde_knife", 100, 0,
        ...
        { Survivor = true, Psycho = true, Prototype = true, Assault = true, SpecOps = true, Reverend = true, Heavy = true, Juggernaut = true, Medic = true, Hatcher = true, Demolition = true, Ghost = true, Gunslinger = true, Engineer = true, Berserker = true, Samurai = true, Spellsword = true, ["Cyborg Ninja"] = true, Warden = true, Overlord = true, Paladin = true, Cremator = true },
        10, -1, nil, nil, nil, nil, { HORDE.DMG_SLASH }, nil, { "Berserker", "Samurai", "Cyborg Ninja", "Paladin", "Spellsword" } )
    ...
    HORDE:CreateItem( "Melee", "Kunai", "arccw_horde_kunai", 1750, 2,
        ...
        { Survivor = true, Psycho = true, Prototype = true, Berserker = true, Samurai = true, Spellsword = true, ["Cyborg Ninja"] = true, Paladin = true },
    ...
    HORDE:CreateItem( "Melee", "Chainsaw", "arccw_horde_chainsaw", 2500, 6,
        ...
        { Berserker = true, Samurai = true, Spellsword = true, ["Cyborg Ninja"] = true, Paladin = true },
    ...
    HORDE:CreateItem( "Melee", "Inferno", "arccw_horde_inferno_blade", 2500, 6,
        ...
        { Berserker = true, Samurai = true, Spellsword = true, ["Cyborg Ninja"] = true, Paladin = true, Cremator = true },
    ...
    HORDE:CreateItem( "Melee", "Zweihänder", "arccw_horde_zweihander", 3000, 8,
        ...
        "Basic 9mm USP.",
        { Survivor = true, Psycho = true, Prototype = true, Assault = true, SpecOps = true, Reverend = true, Heavy = true, Juggernaut = true, Medic = true, Hatcher = true, Demolition = true, Ghost = true, Gunslinger = true, Engineer = true, Berserker = true, Samurai = true, Spellsword = true, ["Cyborg Ninja"] = true, Warden = true, Overlord = true, Cremator = true },
