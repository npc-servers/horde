...
HORDE.difficulty_health_multiplier = {1, 1.25, 1.5, 1.5, 1.5, 1.5}
...
HORDE.difficulty_break_health_left = {0.20, 0.15, 0.10, 0.10, 0.05, 0.20}
HORDE.difficulty_shock_damage_increase = {0.15, 0.20, 0.25, 0.25, 0.30, 0.30}
...
HORDE.difficulty_elite_mutation_probability = {0, 0.05, 0.10, 0.30, 0.40, 0.50}
