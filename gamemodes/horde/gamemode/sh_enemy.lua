...
function HORDE:GetDefaultEnemiesData ()
    ...
    if GetConVar( "horde_difficulty" ):GetInt() == 8 then -- Chaos difficulty
        ...
        HORDE:CreateEnemy("Hulk",   "npc_vj_horde_hulk",                        0.05,  4, true, 0.75, 1, 2, 1, nil,nil,nil,nil,nil,nil,nil,1)
    ...
    HORDE:CreateEnemy("Armed H.E.V. Zombie", "npc_vj_ezt_weapbie",      0.05,  4, false, 1, 1, 1.15, 1)
    HORDE:CreateEnemy("H.E.V. Zombie Shotgunner", "npc_vj_ezt_shotbie",      0.05,  4, false, 1, 1, 1.15, 1)
    HORDE:CreateEnemy("Manhackbie", "npc_vj_ezt_manhackbie",                    0.1,  4, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Armed H.E.V. Zombie", "npc_vj_ezt_weapbie",      0.1,  5, false, 1, 1., 1.15, 1)
    HORDE:CreateEnemy("H.E.V. Zombie Shotgunner", "npc_vj_ezt_shotbie",      0.1,  5, false, 1, 1., 1.15, 1)
    HORDE:CreateEnemy("Lesser Hunter", "npc_vj_ezo_archunter",                  0.05,  5, true, 0.75, 1, 1.3, 1)
    ...
    {is_boss=true, end_wave=true, unlimited_enemies_spawn=true, enemies_spawn_threshold=0.75, music="music/hl2_song3.mp3", music_duration=91})
    ...
    {is_boss=true, end_wave=true, unlimited_enemies_spawn=true, enemies_spawn_threshold=0.5, music="music/hl2_song3.mp3", music_duration=91}, "none", nil, nil, nil, {gadget="gadget_hellfire_tincture", drop_rate=0.5})
    HORDE:CreateEnemy("Xen Host Unit","npc_vj_horde_xen_host_unit", 1, 5, true, 1, 1, 10, 1, nil, nil, nil,
    {is_boss=true, end_wave=true, unlimited_enemies_spawn=true, enemies_spawn_threshold=0.5, music="music/hl2_song20_submix0.mp3", music_duration=104}, "none", nil, nil, nil, {gadget="gadget_matriarch_womb", drop_rate=0.5})
    ...
    HORDE:CreateEnemy("Armed H.E.V. Zombie", "npc_vj_ezt_weapbie",      0.12,  6, false, 1, 1.05, 1.2, 1)
    ...
    HORDE:CreateEnemy("Armed H.E.V. Zombie", "npc_vj_ezt_weapbie",      0.12,  7, false, 1, 1.05, 1.2, 1)
    HORDE:CreateEnemy("H.E.V. Zombie Shotgunner", "npc_vj_ezt_shotbie",      0.12,  7, false, 1, 1.05, 1.2, 1)
    HORDE:CreateEnemy("Lesser Hunter", "npc_vj_ezo_archunter",                  0.05,  7, true, 1, 1, 1.25, 1)
    HORDE:CreateEnemy("Hell Hunter", "npc_vj_ezo_vorthunter",                  0.05,  7, true, 1, 1, 1.5, 1)
    HORDE:CreateEnemy("Manhackbie", "npc_vj_ezt_manhackbie",                    0.1,  7, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Armed H.E.V. Zombie", "npc_vj_ezt_weapbie",      0.12,  8, false, 1, 1.05, 1.2, 1)
    HORDE:CreateEnemy("H.E.V. Zombie Shotgunner", "npc_vj_ezt_shotbie",      0.12,  8, false, 1, 1.05, 1.2, 1)
    HORDE:CreateEnemy("Lesser Hunter", "npc_vj_ezo_archunter",                  0.05,  8, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Hell Hunter", "npc_vj_ezo_vorthunter",                  0.05,  8, true, 1, 1, 1.5, 1)
    HORDE:CreateEnemy("Manhackbie", "npc_vj_ezt_manhackbie",                    0.1,  8, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Armed H.E.V. Zombie", "npc_vj_ezt_weapbie",      0.12,  9, false, 1, 1.05, 1.2, 1)
    HORDE:CreateEnemy("H.E.V. Zombie Shotgunner", "npc_vj_ezt_shotbie",      0.12,  9, false, 1, 1.05, 1.2, 1)
    HORDE:CreateEnemy("Lesser Hunter", "npc_vj_ezo_archunter",                  0.05,  9, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Hell Hunter", "npc_vj_ezo_vorthunter",                  0.05,  9, true, 1, 1, 1.5, 1)
    HORDE:CreateEnemy("Manhackbie", "npc_vj_ezt_manhackbie",                    0.1,  9, false, 1, 1, 1, 1)
