...
function HORDE:GetDefaultEnemiesData ()
    ...
    if GetConVar( "horde_difficulty" ):GetInt() == 8 then -- Chaos difficulty
        ...
        HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",     0.01, 3, true, 1, 1, 1.5, 1, nil, nil, nil, nil, nil, nil, nil, 1)
        ...
        HORDE:CreateEnemy("Lesser Hunter",      "npc_vj_ezo_archunter",         0.01, 4, true, 1, 1, 1.5, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("H.E.V. Zombie Shotgunner",   "npc_vj_ezt_shotbie",       0.03, 4, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",         0.04, 8, true, 1, 1, 1.5, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",         0.04, 9, true, 1, 1, 1.5, 1, nil, nil, nil, nil, nil, nil, nil, 1)
