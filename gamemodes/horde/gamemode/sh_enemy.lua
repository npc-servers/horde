...
function HORDE:GetDefaultEnemiesData ()
    ...
    if GetConVar( "horde_difficulty" ):GetInt() == 8 then -- Chaos difficulty
        ...
        HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",    0.12, 2, true, 1, 1, 1, 1, nil, nil, nil, nil, nil, nil, nil, 1)
        HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",   0.15, 2, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
        ...
        HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",    0.12, 3, true, 1, 1, 1, 1, nil, nil, nil, nil, nil, nil, nil, 1)
        HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",   0.15, 3, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
        ...
        HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",     0.02, 3, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
        ...
        HORDE:CreateEnemy("Lesser Hunter",      "npc_vj_ezo_archunter",         0.02, 4, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
        HORDE:CreateEnemy("Scorcher",           "npc_vj_horde_scorcher",        0.08, 4, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)

        HORDE:CreateEnemy("Charred Zombine",    "npc_vj_horde_charred_zombine", 0.12, 5, false, 1, 1, 1, 1)
        HORDE:CreateEnemy("Scorcher",           "npc_vj_horde_scorcher",        0.08, 5, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
        ...
        HORDE:CreateEnemy("Hell Hunter",    "npc_vj_ezo_vorthunter",        0.01, 6, true, 1, 1, 3, 1, nil, nil, nil, nil, nil, nil, nil, 1)
        HORDE:CreateEnemy("Blight",         "npc_vj_horde_blight",          0.12, 6, true, 1, 1, 1.4, 1)
        HORDE:CreateEnemy("Weeper",         "npc_vj_horde_weeper",          0.12, 6, true, 1, 1, 1.4, 1, nil, nil,nil, nil,nil, nil, nil, 1)
        HORDE:CreateEnemy("Yeti",           "npc_vj_horde_yeti",            0.08, 6, true, 1, 1, 2.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)

        HORDE:CreateEnemy("Weeper", "npc_vj_horde_weeper",  0.12, 7, true, 1, 1, 1.4, 1, nil, nil,nil, nil,nil, nil, nil, 1)
        HORDE:CreateEnemy("Yeti",   "npc_vj_horde_yeti",    0.08, 7, true, 1, 1, 2.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    end
    ...
    HORDE:CreateEnemy("Exploder",               "npc_vj_horde_exploder",    0.20, 1, true, 1, 1, 1.2, 1)
    ...
    HORDE:CreateEnemy("Exploder",       "npc_vj_horde_exploder",    0.20, 2, true, 1, 1, 1.2, 1)
    ...
    HORDE:CreateEnemy("Exploder",       "npc_vj_horde_exploder",    0.20, 3, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Vomitter",       "npc_vj_horde_vomitter",    0.12, 3, true, 1, 1, 1, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Exploder",                   "npc_vj_horde_exploder",    0.20, 4, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",    0.12, 4, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",   0.15, 4, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Exploder",                   "npc_vj_horde_exploder",    0.20, 5, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",    0.12, 5, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",   0.15, 5, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",     0.02, 5, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Exploder",                   "npc_vj_horde_exploder",        0.20, 6, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.12, 6, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Scorcher",                   "npc_vj_horde_scorcher",        0.08, 6, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.15, 6, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",         0.02, 6, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Exploder",                   "npc_vj_horde_exploder",        0.20, 7, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Blight",                     "npc_vj_horde_blight",          0.12, 7, true, 1, 1, 1.4, 1)
    HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.12, 7, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Scorcher",                   "npc_vj_horde_scorcher",        0.08, 7, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.15, 7, true, 1, 1, 1.2, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",         0.02, 7, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Hell Hunter",                "npc_vj_ezo_vorthunter",        0.01, 7, true, 1, 1, 3, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Exploder",                   "npc_vj_horde_exploder",        0.25, 8, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Blight",                     "npc_vj_horde_blight",          0.18, 8, true, 1, 1, 1.4, 1, nil, nil,nil, nil,nil, nil, nil, 1)
    HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.14, 8, true, 1, 1, 1.2, 1, nil, nil,nil, nil,nil, nil, nil, 1)
    HORDE:CreateEnemy("Scorcher",                   "npc_vj_horde_scorcher",        0.10, 8, true, 1, 1, 1.2, 1, nil, nil,nil, nil,nil, nil, nil, 1)
    HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.20, 8, true, 1, 1, 1.2, 1, nil, nil,nil, nil,nil, nil, nil, 1)
    HORDE:CreateEnemy("Weeper",                     "npc_vj_horde_weeper",          0.12, 8, true, 1, 1, 1.4, 1, nil, nil,nil, nil,nil, nil, nil, 1)
    HORDE:CreateEnemy("Hulk",                       "npc_vj_horde_hulk",            0.15, 8, true, 1, 1, 2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Yeti",                       "npc_vj_horde_yeti",            0.08, 8, true, 1, 1, 2.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",         0.05, 8, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Hell Hunter",                "npc_vj_ezo_vorthunter",        0.02, 8, true, 1, 1, 3, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Exploder",                   "npc_vj_horde_exploder",        0.25, 9, true, 1, 1, 1.2, 1)
    HORDE:CreateEnemy("Blight",                     "npc_vj_horde_blight",          0.18, 9, true, 1, 1, 1.4, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Vomitter",                   "npc_vj_horde_vomitter",        0.14, 9, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Scorcher",                   "npc_vj_horde_scorcher",        0.10, 9, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Screecher",                  "npc_vj_horde_screecher",       0.20, 9, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Weeper",                     "npc_vj_horde_weeper",          0.18, 9, true, 1, 1, 1.4, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Hulk",                       "npc_vj_horde_hulk",            0.15, 9, true, 1, 1, 2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Yeti",                       "npc_vj_horde_yeti",            0.10, 9, true, 1, 1, 2.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",         0.05, 9, true, 1, 1, 1.2, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    HORDE:CreateEnemy("Hell Hunter",                "npc_vj_ezo_vorthunter",        0.02, 9, true, 1, 1, 3, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    print("[HORDE] - Loaded NPCZ enemy config.")
end
