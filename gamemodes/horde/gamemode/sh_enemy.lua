...
--        HORDE:CreateEnemy("Hell Hunter",    "npc_vj_ezo_vorthunter",        0.02, 6, true, 1, 1, 3.5, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Sprinter",               "npc_vj_horde_sprinter",    0.60, 1, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Sprinter",       "npc_vj_horde_sprinter",    0.60, 2, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Sprinter",       "npc_vj_horde_sprinter",    0.60, 3, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Sprinter",                   "npc_vj_horde_sprinter",    0.60, 4, false, 1, 1, 1, 1)
    ...
    HORDE:CreateEnemy("Sprinter",                   "npc_vj_horde_sprinter",    0.60, 5, false, 1, 1, 1, 1)
...
--    HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",     0.05*0.5, 5, true, 1, 1, 1.5, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Crawler",                    "npc_vj_horde_crawler",         0.60, 6, false, 1, 1, 1, 1)
...
--    HORDE:CreateEnemy("Lesser Hunter",              "npc_vj_ezo_archunter",         0.05, 6, true, 1, 1, 1.5, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Crawler",                    "npc_vj_horde_crawler",         0.60, 7, false, 1, 1, 1, 1)
...
--    HORDE:CreateEnemy("Hell Hunter",                "npc_vj_ezo_vorthunter",        0.02, 9, true, 1, 1, 3.5, 1, nil, nil, nil, nil, nil, nil, nil, 1)
    ...
    HORDE:CreateEnemy("Crawler",        "npc_vj_horde_crawler",     1.00, 10, false, 1, 1, 1, 1)
