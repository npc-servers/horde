...
ENT.NextManhack = 0
ENT.Leader = nil
ENT.AnimTbl_WeaponReload = {"reload_shotgun1"}
ENT.AnimTbl_WeaponReloadBehindCover = {"reload_shotgun1"}
...
ENT.Weapon_FiringDistanceFar = 700
...
function ENT:CustomOnInitialize()
	...
	if p <= 0.5 then
		...
		self:Give("weapon_vj_horde_shitgun")
		--	self.Weapon_FiringDistanceFar = 15
		--	self.Weapon_FiringDistanceClose = 2
	end
end
