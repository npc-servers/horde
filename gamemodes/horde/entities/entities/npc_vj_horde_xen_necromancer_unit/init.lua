...
function ENT:MultipleRangeAttacks()
	...
	if randomRangeAttack == 1 then
		...
		self.RangeAttackEntityToSpawn = "obj_vj_horde_necromancer_projectile_c"
	...
	elseif randomRangeAttack == 2 then
		...
		self.RangeAttackEntityToSpawn = "obj_vj_horde_necromancer_projectile_b"
		...
		self.HasRangeAttackSound = true
		self.AnimTbl_RangeAttack = { "vjseq_attack_range_projec" }
		self.RangeAttackEntityToSpawn = "obj_vj_horde_necromancer_projectile_a"
