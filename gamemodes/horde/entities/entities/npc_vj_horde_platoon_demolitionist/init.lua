...
ENT.GrenadeAttackEntity = "horde_vj_platoon_demolitionist_nade"
...
function ENT:CustomOnTakeDamage_BeforeDamage( dmginfo, hitgroup )
	if not HORDE:IsBlastDamage( dmginfo ) then return end
...
VJ.AddNPC( "Platoon Demolitionist", "npc_vj_horde_platoon_demolitionist", "Zombies" )