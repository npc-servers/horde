...
function ENT:KeyValue(key, value)
	...
	if key == "startingmoney" then
        ...
        HORDE.start_money = math.floor(HORDE.start_money * HORDE.difficulty_start_money_multiplier[HORDE.CurrentDifficulty])
    ...
    elseif key == "killrewardbase" then
        ...
        HORDE.kill_reward_base = math.floor(tonumber(value) * HORDE.difficulty_reward_base_multiplier[HORDE.CurrentDifficulty])
    elseif key == "roundbonusbase" then
        HORDE.round_bonus_base = v or HORDE.round_bonus_base
        HORDE.round_bonus_base = math.floor(tonumber(value) * HORDE.difficulty_reward_base_multiplier[HORDE.CurrentDifficulty])
	end
end