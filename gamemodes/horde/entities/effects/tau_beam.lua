...
function EFFECT:Render()
    ...
    if self.has_burner then
        render.DrawBeam( self.StartPos, self.EndPos, 5, texcoord, texcoord + self.Length / 1024, Color( 0, 150, 255, math.Clamp( self.Alpha, 0, 255 ) ) )
    else
        render.DrawBeam( self.StartPos, self.EndPos, 5, texcoord, texcoord + self.Length / 1024, Color( 255, 208, 0, math.Clamp( self.Alpha, 0, 255 ) ) )
    end
end