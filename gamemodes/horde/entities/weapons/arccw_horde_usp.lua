...
SWEP.FirstShootSound = {")arccw_go/usp/usp_unsilenced_01.wav",")arccw_go/usp/usp_unsilenced_02.wav",")arccw_go/usp/usp_unsilenced_03.wav"}
SWEP.ShootSound = {")arccw_go/usp/usp_unsilenced_01.wav",")arccw_go/usp/usp_unsilenced_02.wav",")arccw_go/usp/usp_unsilenced_03.wav"}
