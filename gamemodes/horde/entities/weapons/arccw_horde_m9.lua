...
SWEP.FirstShootSound = {")arccw_go/elite/elites_01.wav",")arccw_go/elite/elites_02.wav",")arccw_go/elite/elites_03.wav",")arccw_go/elite/elites_04.wav"}
SWEP.ShootSound = {")arccw_go/elite/elites_01.wav",")arccw_go/elite/elites_02.wav",")arccw_go/elite/elites_03.wav",")arccw_go/elite/elites_04.wav"}
...
SWEP.Attachments = {
    {PrintName = "Optic"}, {PrintName = "Tactical"}, {PrintName = "Slide"}, {PrintName = "Muzzle"}, {PrintName = "Magazine"},
    {
        PrintName = "Stock",
