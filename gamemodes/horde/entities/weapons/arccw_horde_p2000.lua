...
sound.Add( {
    name = "ArcCW_Horde.GSO.P2000_Fire",
    channel = CHAN_STATIC,
    volume = 1.0,
    level = 90,
    pitch = {99, 101},
    sound = {")arccw_go/hkp2000/hkp2000_01.wav",")arccw_go/hkp2000/hkp2000_02.wav",")arccw_go/hkp2000/hkp2000_03.wav"}
} )
sound.Add( {
    name = "ArcCW_Horde.GSO.P2000_Fire_Sil",
    channel = CHAN_STATIC,
    volume = 1.0,
    level = 75,
    pitch = 100,
