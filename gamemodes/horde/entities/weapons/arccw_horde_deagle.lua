...
SWEP.FirstShootSound = {")arccw_go/deagle/deagle_01.wav",")arccw_go/deagle/deagle_02.wav"}
SWEP.ShootSound = {")arccw_go/deagle/deagle_01.wav",")arccw_go/deagle/deagle_02.wav"}
